...
class PreprocessDatasetConfig(BaseModel):
    dataset_prefix: str
    max_chars: int = (
...
class PreprocessDataset:
    ...
    def __init__(self, preprocess_dataset_config: PreprocessDatasetConfig):
        self._config = preprocess_dataset_config
        # Initialize Ray
        try:
            ray.shutdown()
...
if __name__ == "__main__":
    ...
    for config in configs:
        ...
        bert_pretraining_config = PreprocessDatasetConfig(**config)
        bert_pretraining_dataset = PreprocessDataset(bert_pretraining_config)
